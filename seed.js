...
const categories = [
  { name: 'Furniture', slug: 'furniture', description: 'Bàn ghế, tủ kệ và các đồ nội thất 3D' },
  { name: 'Characters', slug: 'characters', description: 'Nhân vật 3D, con người và sinh vật' },
  { name: 'Vehicles', slug: 'vehicles', description: 'Xe cộ, máy bay, tàu thuyền' },
  { name: 'Architecture', slug: 'architecture', description: 'Kiến trúc, nhà cửa, công trình' },
  { name: 'Electronics', slug: 'electronics', description: 'Thiết bị điện tử, máy móc' },
  { name: 'Nature', slug: 'nature', description: 'Cây cối, đá, cảnh quan tự nhiên' },
  { name: 'Weapons', slug: 'weapons', description: 'Vũ khí, công cụ chiến đấu' },
  { name: 'Food', slug: 'food', description: 'Thức ăn, đồ uống' }
];
